class FixIndecesInDescriptions < ActiveRecord::Migration[5.2]
   def change
      change_table :descriptions do |t|
         ...
         t.index %i(language_code alphabeth_code type describable_id describable_type), name: :index_on_language_code_alphabeth_code_type_and_describables ;end;end;end
