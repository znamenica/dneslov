   ...
   def change
      ...
      change_table :descriptions do |t|
         ...
         t.index ["describable_id", "describable_type", "alphabeth_code"],
            unique: true, name: "describable_alphabeth_index"
      end
      ...
      change_table :services do |t|
         ...
         t.remove_index ["name", "language_code"]
      end
      ...
      change_table :chants do |t|
         ...
         t.remove_index ["text", "language_code"]
      end
   end
end
