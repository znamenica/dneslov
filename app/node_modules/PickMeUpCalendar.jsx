...
export default class PickMeUpCalendar extends Component {
   ...
   constructor(props) {
      ...
      //console.log(util.inspect(Pickmeup))
   ...
   recalculateGap = () => {
      //console.log("GAP", this.isJulian() && -13 || 0)
      return this.isJulian() && -13 || 0
   }

   isJulian = (value) => {
      //console.log("JULIAN", util.inspect(((value || this.state.calendar_style) == 'julian')))
   ...
   getToday = () => {
      ...
      //console.log("TODAY", util.inspect(today))
   ...
   onPickmeupRender = () => {
      //console.log("selected date", util.inspect(this.getToday()))
