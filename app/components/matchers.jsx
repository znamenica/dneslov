...
export function matchLetters(textIn, context) {
   ...
   case 'РО':
      ...
      break
   case 'ЦС':
      res = ! text.match(/^[҂҃҄҇꙼꙾ⷣⷮ꙽ꙿ̀̾҅҆̑А-ЬЮЅІѠѢѦѮѰѲѴѶѸѺѼѾꙖꙊа-ьюєѕіѡѣѧѯѱѳѵѷѹѻѽѿꙗꙋ:,.!;\-\/*\r\n \*~`\+\-#=>\[\]\(\)!\|]+$/)
      break
   case 'РУ':
   ...
   case 'ЦР':
      ...
      break
   case 'СС':
      res = ! text.match(/^[꙯꙰꙲꙱ⷠⷡⷢⷣⷤⷥⷦⷧⷨⷩⷪⷫⷬⷭⷮⷯⷰⷱⷲⷳⷴⷵⷶⷷⷸⷹⷺⷻⷼⷽⷾⷿꙴꙵꙶꙷꙸꙹꙺꙻ꙽ꙿꚜꚝꚞꚟ︮︯꙳꙼꙾҂҃҄҇҈҉А-ЬЮЅІѠѢѦѪѮѰѲѴѶѸѺѾꙖа-ьюєѕіѡѣѧѫѯѱѳѵѷѹѻѿꙗѨѩѬѭѸѹҀҁꙀꙁꙂꙃꙄꙅꙆꙇꙈꙉꙊꙋꙌꙍꙎꙏꙐꙑꙒꙓꙔꙕꙘꙙꙚꙛꙜꙝꙨꙩꙪꙫꙬꙭꙮꚘꚙꚚꚛ.́,;*\r\n \*~`\+\-#=>\[\]\(\)!\|]+$/) //TODO
      break
   case 'УК':
