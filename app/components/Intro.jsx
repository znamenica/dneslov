   ...
   static defaultProps = {
      ...
      steps: [
         ...
         },
         {
            ...
            intro: 'Строка поиска позволяет вам искать памяти святых, икон или предметов по имени или описанию. Поисковая строка может разделяться пробелами и знаками «+». Если слова разделены пробелами, то при поиск будут выбираться памяти, в описании или имени которых будет упоминаться ЛЮБОЕ из слов, если слова разделены «плюсами», то памяти, с упоминанием ВСЕХ слов связанных «плюсом».',
            position: 'top',
            datestamp: '20171213185700',
         },
         {
            element: '#calendaries-cloud',
            intro: 'Облако календарей содержит все доступные для выборки календари, при нажатии на знака «+» напротив имени календаря, будет произведён новый поиск памятей с дополнительным условием выборки, а именно выбираться памяти будут дополнительно также и из выбранного календаря. Если «плюс» отсутствует, в этом случае календарь уже выбран как условие поиска.',
            position: 'right',
            datestamp: '20171213185700',
         },
         {
            element: '#search-conditions',
            intro: 'Выборка показывает условия, по которым был проведён поиск памятей. Условия могут включать: дату поиска, задающую выбор памятей, события которых удовлетворяют выбранной дате, также наименования календарей, которых может быть несколько, и тогда памяти будут включены из нескольких избранных календарей сразу, а ещё включать слова из строки поиска. Каждое из условий выборки можно убрать нажав на «крестик» напротив текста сего условия.',
            position: 'bottom',
            datestamp: '20171213185700',
         },
         {
         ...
         },
         {
            ...
            intro: 'Чин является краткой строкой поясняющей вид памяти, напр. «свт», «прав», «обр», и т.п.',
            position: 'right',
            datestamp: '20171213185700',
         },
         {
