...
import BindKindField from 'BindKindField'
...
export default class NameForm extends Component {
   ...
   static validations = {
      'Вид связки не должен иметь значение "Не связанное" в случае, если связаное имя задано': (state) => {
         return state.bond_to_id && state.bind_kind == "несвязаное"
      },
      'Вид связки должен иметь значение "Не связанное" в случае, если связаное имя отсутствует': (state) => {
         return !state.bond_to_id && state.bind_kind != "несвязаное"
      },
      'Связаное имя не должно соответствовать названию текущего имени': (state) => {
         return state.bond_to && state.bond_to == state.text
      },
      'Корневое имя не должно соответствовать названию текущего имени': (state) => {
         return state.root && state.root == state.text
      },
   }
